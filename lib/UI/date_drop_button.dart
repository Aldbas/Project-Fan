...
class DateSelectorState extends State<DateSelector> {
  ...
  static const int GAMES_DATE_OFFSET = 10;
  static const Color SELECTED_COLOR = Colors.orange;
...
//      itemCount: 2,
          itemBuilder: (BuildContext context, int index) {
            ...
            print(dateItem.isAtSameMomentAs(_currentDate));
